...
public class GenesisTimeData extends SavedData {
    ...
    public static final SavedData.Factory<GenesisTimeData> FACTORY = new SavedData.Factory<>(
            GenesisTimeData::new,
    ...
    public static GenesisTimeData load(CompoundTag tag, HolderLookup.Provider provider) {
