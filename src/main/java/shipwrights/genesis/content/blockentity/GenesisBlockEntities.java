...
public class GenesisBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TulciteCatalyzerBlockEntity>> TULCITE_CATALYZER_BLOCK_ENTITY =
            BLOCK_ENTITIES.register("tulcite_catalyzer_block",
                    () -> BlockEntityType.Builder.of(TulciteCatalyzerBlockEntity::new,
                            GenesisBlocks.TULCITE_CATALYZER_BLOCK.get()).build(null));
