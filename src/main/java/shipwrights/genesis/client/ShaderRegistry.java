...
public class ShaderRegistry {
    ...
    public static final ShaderHolder BLACKHOLE_SHADER = new ShaderHolder(ResourceLocation.fromNamespaceAndPath(NeoGenesisMod.MOD_ID, "blackhole"), DefaultVertexFormat.POSITION_COLOR);
    public static final ShaderHolder PLANET_SHADER = new ShaderHolder(ResourceLocation.fromNamespaceAndPath(NeoGenesisMod.MOD_ID, "planet"), DefaultVertexFormat.POSITION_COLOR_TEX);
    public static final ShaderHolder PLANET_ATMOSPHERE_SHADER = new ShaderHolder(ResourceLocation.fromNamespaceAndPath(NeoGenesisMod.MOD_ID, "planet_atmosphere"), DefaultVertexFormat.POSITION_COLOR);
    public static final ShaderHolder PLANET_TEXTURED_SHADER = new ShaderHolder(ResourceLocation.fromNamespaceAndPath(NeoGenesisMod.MOD_ID, "planet_textured"), DefaultVertexFormat.POSITION_TEX_COLOR_NORMAL);
    public static final ShaderHolder PLANET_MASK_SHADER = new ShaderHolder(ResourceLocation.fromNamespaceAndPath(NeoGenesisMod.MOD_ID, "planet_mask"), DefaultVertexFormat.POSITION_COLOR);
    public static final ShaderHolder PLANET_SHADOW_SHADER = new ShaderHolder(ResourceLocation.fromNamespaceAndPath(NeoGenesisMod.MOD_ID, "planet_shadow"), DefaultVertexFormat.POSITION_COLOR);
    public static final ShaderHolder WORMHOLE_SHADER = new ShaderHolder(ResourceLocation.fromNamespaceAndPath(NeoGenesisMod.MOD_ID, "wormhole"), DefaultVertexFormat.POSITION_COLOR_TEX);
    public static final ShaderHolder STAR_GLOW_SHADER = new ShaderHolder(ResourceLocation.fromNamespaceAndPath(NeoGenesisMod.MOD_ID, "star_glow"), DefaultVertexFormat.POSITION_COLOR);
